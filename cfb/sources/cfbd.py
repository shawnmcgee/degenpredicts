    ...
    for st in types:
        ...
        for g in data:
            ...
            rows.append({
                ...
                # CFBD flags unscheduled kickoffs with startTimeTBD and stamps a placeholder
                # time (usually midnight or noon ET). Rendering that as a real kickoff is worse
                # than saying nothing, so TBD games carry no time.
